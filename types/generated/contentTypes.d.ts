...
export interface ApiLayoutLayout extends Schema.SingleType {
  ...
  attributes: {
    ...
    legal: Attribute.Component<'ui.button', true>;
    copyright: Attribute.String;
    footerHeadingTop: Attribute.Text;
    footerHeadingBottom: Attribute.Text;
    footerVideo: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    blocks: Attribute.DynamicZone<
      ['post.hero', 'shared.related', 'post.content']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProjectCategoryProjectCategory
  ...
  attributes: {
    title: Attribute.String;
    slug: Attribute.UID<'api::project-category.project-category', 'title'>;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blocks: Attribute.DynamicZone<
      ['service.hero', 'service.info', 'service.related', 'service.cta']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
